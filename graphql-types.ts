...
export type SitePageFieldsEnum = 
  ...
  | 'pluginCreator___pluginOptions___icons___purpose'
...
export type SitePluginFieldsEnum = 
  ...
  | 'pluginOptions___icons___purpose'
...
export type BioQueryQuery = { avatar?: Maybe<{ childImageSharp?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixedFragment> }> }>, site?: Maybe<{ siteMetadata?: Maybe<{ author?: Maybe<Pick<Author, 'name' | 'summary'>>, social?: Maybe<Pick<Social, 'twitter' | 'github'>> }> }> };
...
export type Unnamed_2_Query = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMdx: { nodes: Array<(
      Pick<Mdx, 'excerpt'>
...
export type BlogPostBySlugQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'siteUrl'>> }>, mdx?: Maybe<(
    ...
    & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'date' | 'description'>>, fields?: Maybe<(
      Pick<MdxFields, 'slug'>
      & { readingTime?: Maybe<Pick<MdxFieldsReadingTime, 'text'>> }
    )> }
